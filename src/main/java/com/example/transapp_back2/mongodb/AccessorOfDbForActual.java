...
public class AccessorOfDbForActual implements AccessorOfDb {
    ...
    //コンストラクタ
    public void setDbPreparation(String collectionName){
    ...
    private void getMongoCollection(){
        ...
        System.out.println(operableCollection);
    }
